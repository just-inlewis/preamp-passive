...
def main():
    ...
    parser.add_argument('--attenuatorType', type=int, choices=[0,1], default=0, help='Attenuator type: 0 (constant input), 1 (constant output) (default: 0)')
    parser.add_argument('--resistance', type=float, default=10000, help='Resistance in ohms (default: 10000)')
